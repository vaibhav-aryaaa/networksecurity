...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        """
        It initializes a KNNImputer object with the parameters specified in the training_pipeline.py file and return a pipeline object with the KNNImputer object as the first step.
